    ...
    return (
        <main className="mt-16">
            ...
            <section className="mt-6">
                <ul className="flex flex-wrap justify-start items-center">{squad.map(player => <PlayerBox key={player.id} id={player.id} name={player.name} image={player.image} shirtNumber={player.shirtNumber} captain={player.captain} />)}</ul>
            </section>
        </main>
    )
}
